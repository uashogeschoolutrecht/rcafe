...
Using list-columns - Demo for the R Cafe Universiteit Utrecht, 28 January 2019 </div>
...
## Who am I?
 ...
 - Validation and development of in-vitro 
 methods for toxicology (Hogeschool Utrecht)
...
**There is more than we can cover today**

 PART II: MORE LIST-COLUMNS (do-it-yourself) 

## Getting access and materials

Clone the repository to your RStudio Env. from:
